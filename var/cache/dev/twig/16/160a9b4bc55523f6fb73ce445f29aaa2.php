...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/exception.html.twig", "/home/stud/Documents/Admin_web/TP6/tpweb/vendor/symfony/web-profiler-bundle/Resources/views/Collector/exception.html.twig");
    }
}
